function position = eval_source_position(t,posini,velocity)

%
% calculate the position of the source along the time t according to the given
...
%           - velocity = vector of source velocity in (x,y,z)
%
%
